...
The rotation matrix $\mathbf{R}$ and the translation vector $\mathbf{t}$ map the positions of the three tracking markers $\mathbf{p_1}, \mathbf{p_2}, \mathbf{p_3}$ determined by the \emph{Optitrack} system onto the positions of the tracking markers in the coordinate system of the stereo camera $\mathbf{p'_1}, \mathbf{p'_2}, \mathbf{p'_3}$, such that $\mathbf{p'_n} = \mathbf{p_n} \mathbf{R} + \mathbf{t}$ holds for $n \in \mathbf{\{1, 2, 3\}}$.
