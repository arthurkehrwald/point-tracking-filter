...
For this, an assignment of the markers must first be made.
...
Of the six possible assignments of the markers measured by the \emph{OptiTrack} system to the marker positions measured by hand in the coordinate system of the stereo camera, the one for which these side lengths agree best is chosen.
If the second-best assignment is worse by less than 0.5~cm, the assignment is considered ambiguous and a warning is issued.
For this reason, only marker geometries whose side lengths differ pairwise by at least 0.5~cm are accepted.
